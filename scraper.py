...
def get_replay_links(base_url, pages=50):
    ...
    for page in range(pages+30, pages + 51):
        ...
        for link in links:
            ...
            if href and "gen9vgc2024regh-" in href:  # Ensure correct format
...
if __name__ == "__main__":
    base_url = "https://replay.pokemonshowdown.com/?format=gen9vgc2024regh&sort=rating"

    print("\n🔍 Scraping Replay Links...")
    replay_links = get_replay_links(base_url, pages=50)  # Adjust pages as needed
